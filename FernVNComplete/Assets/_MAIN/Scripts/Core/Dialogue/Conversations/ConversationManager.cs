...
namespace DIALOGUE
{
    public class ConversationManager
    {
        ...
        IEnumerator Line_RunCommands(DIALOGUE_LINE line)
        {
            ...
            {
                if (command.waitForCompletion || command.name == "wait" || command.name == "PlayCutscene") 
                {
        ...
        IEnumerator BuildDialogue(string dialogue, bool append = false)
        {
            ...
            // Set the font size from the configuration (this assumes you have access to config)
            architect.fontSize = VN_Configuration.activeConfig.dialogueFontSize; 
