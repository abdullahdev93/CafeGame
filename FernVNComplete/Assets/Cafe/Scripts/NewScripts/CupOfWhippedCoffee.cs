...
public class CupOfWhippedCoffee : MonoBehaviour
{
    ...
    public GameObject sprinkledWhippedCoffee;
    ...
    {
        if (other.CompareTag("SprinkleShaker"))
        {
            ...
            Instantiate(sprinkledWhippedCoffee, transform.position + new Vector3(0, -0.2f, 0), transform.rotation);
        }
    }
}
